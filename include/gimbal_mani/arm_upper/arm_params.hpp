...
struct KinematicsParams
{
    ...
    std::vector<std::string> joint_names{
        ...
        "Wrist_Roll",
        "Gripper"};
    std::array<JointLimit, 6> joint_limits{{
        {-0.5 * M_PI, 0.5 * M_PI},
        {-0.5 * M_PI, 0.5 * M_PI},
        {-0.5 * M_PI, 0.5 * M_PI},
        {-M_PI, 0.0},
...
struct TargetLockParams
{
    int min_samples{8};
    double pos_tol_m{0.01};
    double bearing_tol_rad{0.03};
...
struct TofApproachParams
{
    ...
    double range_increase_tol_m{0.005};
    double progress_reverse_tol_m{0.005};
    double cartesian_error_stop_m{0.06};
    double joint_probe_step_rad{0.035};
    double joint_probe_shoulder_ratio{0.3};
    double joint_probe_wrist_ratio{1.0};
    double joint_probe_command_time_sec{0.25};
    double joint_probe_reach_tol_rad{0.02};
    double success_range_delta_m{0.002};
    double fail_range_increase_m{0.002};
    int max_failed_probe_count{6};
};
...
struct ArmUpperParams
{
    KinematicsParams kinematics;
    TargetLockParams target_lock;
    GraspParams grasp;
    TofApproachParams tof;
    DebugParams debug;
};
